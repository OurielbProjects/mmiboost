...
const socials = [
  {
    name: 'Instagram',
    href: 'https://instagram.com/mmiboost',
    icon: (
  ...
  {
    name: 'TikTok',
    href: 'https://tiktok.com/@mmiboost',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/company/mmiboost',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Twitter/X',
    href: 'https://twitter.com/mmiboost',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-14">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-2">
              ...
              <a href="tel:+33000000000" className="flex items-center gap-2 text-sm text-gray-400 hover:text-white transition-colors">
                <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex items-center gap-3 mt-6">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.name}
                  className="w-9 h-9 rounded-lg glass flex items-center justify-center text-gray-400 hover:text-white hover:border-blue-500/30 transition-all duration-200"
                >
                  {s.icon}
                </a>
              ))}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gray-500">
            © {new Date().getFullYear()} MMI Boost. Tous droits réservés.
          </p>
          <div className="flex items-center gap-1 text-xs text-gray-600">
            <span>Construit avec</span>
            <span className="text-red-500">♥</span>
            <span>pour votre succès digital</span>
          </div>
        </div>
      </div>
    </footer>
